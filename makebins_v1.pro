...
;The "data" file above is your fully reduced data frame. It's used to
...
;quick plot occurs
        ...
        for j=0,n_elements(ind)-1 do piece[*,j] = data[*,ind[j]]
...
;------------------------------------------------------------------
    ...
    print,'Name the bin/spectra- it will automatically be subscripted (bin/fits):'
    read,biname
    txt = biname+'.bin'
    fts = biname+'.fits'
    openw,5,txt
