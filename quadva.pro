...
print, 'test 1 ###############################'
quadva, 'quadva_test1', [0d,8d], ifx, errbnd, RELTOL=0d, ABSTOL=1d-12
print, ifx, errbnd, FORMAT='(f20.16," +/- ",e10.1)'
print, 'test 2 ###############################'
quadva, 'quadva_test2', [-1d,2d], ifx, errbnd, RELTOL=0d, ABSTOL=1d-12
print, ifx, errbnd, FORMAT='(f20.16," +/- ",e10.1)'
print, 'test 2 with breakpoints ##############'
quadva, 'quadva_test2', [-1,-1/sqrt(2),1/sqrt(3),2], ifx, errbnd, RELTOL=0d, ABSTOL=1d-12
print, ifx, errbnd, FORMAT='(f20.16," +/- ",e10.1)'
print, 'test 3 ###############################'
quadva, 'quadva_test3', [0d,1d], ifx, errbnd, RELTOL=0d, ABSTOL=1d-12, FUNCTARGS={a:-2d/3d}
print, ifx, errbnd, FORMAT='(f20.16," +/- ",e10.1)'
quadva, 'quadva_test4', [-!VALUES.F_INFINITY,!VALUES.F_INFINITY], ifx, errbnd, RELTOL=1d-5, ABSTOL=0
print, ifx, errbnd, FORMAT='(f20.16," +/- ",e10.1)'
quadva, 'quadva_test4', [-6d,6d], ifx, errbnd, RELTOL=1d-5, ABSTOL=0
print, ifx, errbnd, FORMAT='(f20.16," +/- ",e10.1)'
