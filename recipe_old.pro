...
if (n_elements(rlist) eq 0) then begin
    readcol,rlist,Format='a',rlist
endif else begin readcol,'recipe.list',Format='a',rlist
...
device,decomposed=0
loadct,0
plot,starmix[0,*],xrange=[0,n2+1],xstyle=1,yrange=[-0.2,1.0],ystyle=1,title='!3Stellar Recipe for '+names[0,0],$
  ytitle='Relative Contribution',xtitle='Stellar Type',/nodata,charsize=1.5
FOR j=0,n2-1 DO xyouts,xaxis[j]+0.4,-0.18,tlist[j],orientation=90,charsize=1.5
loadct,4
...
loadct,0
plot,starmix[0,*],xrange=[0,n2+1],xstyle=1,yrange=[-0.2,1.0],ystyle=1,title='!6Stellar Recipe for '+names[0,0],$
  ytitle='Relative Contribution',xtitle='Stellar Type',/nodata,charsize=1.3
FOR j=0,n2-1 DO xyouts,xaxis[j]+0.4,-0.18,tlist[j],orientation=90,charsize=1.2
loadct,4
