; This function is used in BINGEN2D.PRO to generate the bin#### and
...
; MODIFIED on Sept 28, 2011: This code now allows for a 2D map to be
; made. The output is 4 quadrants, named ban, bbn, bcn and bdn. 

FUNCTION rotateF2D, offsetfile, pa, letter
...
; Q4(270 to 360): R is -, A is - 
            ...
            iban =  where(Rp[index] ge 0.0 and Ap[index] ge 0.0,binA)
            ibbn =  where(Rp[index] ge 0.0 and Ap[index] lt 0.0,binB)
            ibcn =  where(Rp[index] lt 0.0 and Ap[index] ge 0.0,binC)
            ibdn =  where(Rp[index] lt 0.0 and Ap[index] lt 0.0,binD)

            if (binA gt 0) then begin
                if (r le 9) then begin
                    tempnameF = 'ban'+strn(0)+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
                    for mm=0,binA-1 do $
                      printf,55,strn(index[iban[mm]]+1)+'_'+letter
                endif else begin
                    tempnameF = 'ban'+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
            ...
            if (binB gt 0) then begin
                if (r le 9) then begin
                    tempnameF = 'bbn'+strn(0)+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
                    for mm=0,binB-1 do $
                      printf,55,strn(index[ibbn[mm]]+1)+'_'+letter
                endif else begin
                    tempnameF = 'bbn'+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
            ...
            if (binC gt 0) then begin
                if (r le 9) then begin
                    tempnameF = 'bcn'+strn(0)+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
                    for mm=0,binC-1 do $
                      printf,55,strn(index[ibcn[mm]]+1)+'_'+letter
                endif else begin
                    tempnameF = 'bcn'+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
            ...
            if (binD gt 0) then begin
                if (r le 9) then begin
                    tempnameF = 'bdn'+strn(0)+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
                    for mm=0,binD-1 do $
                      printf,55,strn(index[ibdn[mm]]+1)+'_'+letter
                endif else begin
                    tempnameF = 'bdn'+strn(r)+strn(0)+strn(a)
                    readcol,tempnameF,f='a',preexisting,silent=1
                    openw,55,tempnameF
                    for mm=0,n_elements(preexisting)-1 do $
                      printf,55,preexisting[mm]
